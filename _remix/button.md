...
<p class="codepen" data-height="265" data-theme-id="dark" data-default-tab="html,result" data-user="p19kala" data-slug-hash="pobgEKo" data-preview="true" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="2o paradoteo">
  <span>See the Pen <a href="https://codepen.io/p19kala/pen/pobgEKo">
  2o paradoteo</a> by Kalathas (<a href="https://codepen.io/p19kala">@p19kala</a>)
...
### Σημειώσεις: Έκανα αντιγραφή το κώδικα embed αλλά δεν δουλεύει όπως θα έπρεπε. Για να δείτε το πρόγραμμα, πατήστε στο σύνδεσμο "2o paradoteo".
